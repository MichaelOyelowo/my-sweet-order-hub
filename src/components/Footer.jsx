...
const SOCIALS =[
  {
    label: 'Instagram',
    href: 'https://instagram.com/sweethub',
    icon: (
  ...
  {
    label: 'TikTok',
    href: 'https://tiktok.com/@sweethub',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'Facebook',
    href: 'https://facebook.com/sweethub',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'Pinterest',
    href: 'https://pinterest.com/sweethub',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'YouTube',
    href: 'https://youtube.com/@sweethub',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="footer-contact-items">
              ...
              >
                ...
                <div className="fci-text">
                  ...
                  <span className="fci-value">hello@sweethub.ng</span>
                </div>
              </a>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-inner">
          ...
          <p className="footer-copy">
            © {year} SweetHUB · Made with love in Nigeria
          </p>
